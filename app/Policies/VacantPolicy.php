...
class VacantPolicy
{
    // En el policy se pasa un campo de la migracion para crear las condiciones, PERO hay casos donde se coloca el modelo completo para prevenir el acceso a ese modelo
    /**
